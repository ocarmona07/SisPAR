...
CREATE TABLE dbo.EST_ESTADOS
    (
      ...
      EST_TIPO VARCHAR(50) COLLATE Modern_Spanish_CI_AS
                           NOT NULL ,
      EST_OBSERVACION VARCHAR(MAX) COLLATE Modern_Spanish_CI_AS
                                   NOT NULL ,
...
CREATE TABLE dbo.EVE_EVENTO
    (
      ...
      EVE_ADJUNTO VARCHAR(MAX) COLLATE Modern_Spanish_CI_AS
                               NOT NULL ,
...
/*==============================================================*/
/* Table: TIP_TIPO_PROCESO                                          */
/*==============================================================*/
CREATE TABLE dbo.TIP_TIPO_PROCESO
    (
      TIP_ID INT IDENTITY(1, 1) ,
      TIP_NOMBRE VARCHAR(MAX) COLLATE Modern_Spanish_CI_AS
                              NOT NULL ,
      CONSTRAINT PK_TIP_TIPO_PROCESO PRIMARY KEY ( TIP_ID ) ON "PRIMARY"
    )
ON  "PRIMARY"
go
...
CREATE TABLE dbo.PRO_PROCESO
    (
      ...
      PRO_NOMBRE VARCHAR(50) COLLATE Modern_Spanish_CI_AS
                             NOT NULL ,
      PRO_TIP_ID INT NOT NULL ,
      PRO_EPR_ID INT NOT NULL ,
      PRO_USU_ID INT NOT NULL ,
      PRO_OBSERVACION VARCHAR(MAX) COLLATE Modern_Spanish_CI_AS
                                   NOT NULL ,
...
/* Table: ANA_ANALISTAS                                           */
/*==============================================================*/
CREATE TABLE dbo.ANA_ANALISTAS
    (
      ANA_ID INT IDENTITY(1, 1) ,
      ANA_SPO_ID INT NOT NULL ,
      ANA_USU_ID INT NOT NULL ,
      ANA_OBSERVACION VARCHAR(MAX) COLLATE Modern_Spanish_CI_AS
                                   NOT NULL ,
      CONSTRAINT PK_ANA_ANALISTAS PRIMARY KEY ( ANA_ID ) ON "PRIMARY"
    )
ON  "PRIMARY"
go
...
CREATE TABLE dbo.URG_URGENCIA
    (
      ...
      URG_TIPO VARCHAR(50) COLLATE Modern_Spanish_CI_AS
                           NOT NULL ,
      URG_OBSERVACION VARCHAR(MAX) COLLATE Modern_Spanish_CI_AS
                                   NOT NULL ,
...
ADD CONSTRAINT FK_TIP_TIPO_PROCESO_PRO_PROCESO FOREIGN KEY (PRO_TIP_ID)
REFERENCES dbo.TIP_TIPO_PROCESO (TIP_ID)
go

ALTER TABLE dbo.PRO_PROCESO
ADD CONSTRAINT FK_EPR_EMPRESA_PRO_PROCESO FOREIGN KEY (PRO_EPR_ID)
REFERENCES dbo.EPR_EMPRESA (EPR_ID)
go

ALTER TABLE dbo.PRO_PROCESO
ADD CONSTRAINT FK_USU_USUARIO_PRO_PROCESO FOREIGN KEY (PRO_USU_ID)
REFERENCES dbo.USU_USUARIO (USU_ID)
go

ALTER TABLE dbo.ANA_ANALISTAS
ADD CONSTRAINT FK_ANA_ANALISTAS_SPO_SUBPROCESO FOREIGN KEY (ANA_SPO_ID)
REFERENCES dbo.SPO_SUBPROCESO (SPO_ID)
go

ALTER TABLE dbo.ANA_ANALISTAS
ADD CONSTRAINT FK_ANA_ANALISTAS_USU_USUARIO FOREIGN KEY (ANA_USU_ID)
REFERENCES dbo.USU_USUARIO (USU_ID)
go
...
ADD CONSTRAINT FK_RES_RESPONSABLE_ROL_ROL FOREIGN KEY (RES_ROL_ID)
...
ALTER TABLE dbo.SPO_SUBPROCESO
ADD CONSTRAINT FK_SPO_SUBPROCESO_USU_USUARIO FOREIGN KEY (SPO_USU_ID)
REFERENCES dbo.USU_USUARIO (USU_ID)
go
